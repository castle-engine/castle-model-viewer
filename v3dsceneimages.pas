...
var
  Examine_tooltip: TRGBAlphaImage;

var
  Walk_fly_tooltip: TRGBAlphaImage;
...
initialization
  ...
  Examine_tooltip := TRGBAlphaImage.Create(Examine_tooltipWidth, Examine_tooltipHeight);
  Move(Examine_tooltipPixels, Examine_tooltip.RawPixels^, SizeOf(Examine_tooltipPixels));
  Walk_fly_tooltip := TRGBAlphaImage.Create(Walk_fly_tooltipWidth, Walk_fly_tooltipHeight);
